...
jQuery( document ).ready(
	function( $ ) {
			...
			$( '.customize-control-alpha-color' ).each( function() {
				var ct_label = $( '.customize-control-title', this ).attr( 'val' );
				var ct_html  = '<span class="customize-control-title">' + ct_label + '</span>';

				$( this ).find( '.wp-picker-container' ).prepend( ct_html );
			} );
	}
);
